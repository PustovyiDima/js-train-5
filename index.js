...
// Завдання 4: Дано масив рядків. За допомогою циклу for переберіть масив, видаліть третій елемент масиву
// та перетворіть кожен елемент в рядок за допомогою методу toString(). Результат виведіть на консоль.
...
function replaceNumbers(arr) {
   ...
   for (let i in arr) {
      if (arr[i] > 10) {
         res[i] = "Greater than 10";
      } else if (arr[i] <= 10) {
         res[i] = "Less than or equal to 10";
      }
   }
   return res;
}
